...
// Stay kinds, the 12h clock formatter and the DayBooking/DayCell shapes now
// live in @/lib/ownerCalendarDay alongside the day-resolution rules they
// belong to, so those rules can be unit tested.
...
export function BookingCalendarSection() {
  ...
  // sellable on that date. The rules themselves live in @/lib/ownerCalendarDay.
  function resolveDay(day: number): DayCell | null {
    return resolveDayCell(dayBookings[day] || []);
  }
