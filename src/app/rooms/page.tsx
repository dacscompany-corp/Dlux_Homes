  ...
  return (
    <div className="page-enter" style={{ minHeight: "100vh", backgroundColor: "var(--bg)", color: "var(--ink)" }}>
      ...
      <section style={{ maxWidth: 1320, margin: "0 auto", padding: "100px 28px 80px", textAlign: "center" }}>
        ...
        <Link href={`/rooms/${room.id}`} className="booknow-btn" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "14px 28px", borderRadius: 999, background: "var(--dlux-accent)", color: "var(--white)", fontSize: 15, fontWeight: 600, textDecoration: "none" }}>
