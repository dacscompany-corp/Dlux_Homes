  ...
  return (
    <div className="si-root">
      <style>{`
        ...
        .si-label__row { display: flex; justify-content: space-between; align-items: baseline; }
        .si-forgot { color: #8a5a34; text-decoration: none; font-size: 15px; font-weight: 500; transition: color .15s; }
        .si-forgot:hover { color: #4a2a16; }
        .si-field {
        ...
        <div className="si-formwrap">
          ...
          <form className="si-form" onSubmit={handleCredentials}>
            ...
            <label className="si-check">
              <span className="si-check__box" style={{ background: remember ? "#a9713f" : "transparent" }}>
                {remember && (
