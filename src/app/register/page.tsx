        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div className="px-8 py-8">
              <button type="button" onClick={() => signIn("google", { callbackUrl })} className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-3 px-4 text-gray-700 font-medium text-sm hover:bg-gray-50 hover:border-gray-300 transition-all cursor-pointer mb-6">
              ...
              <p className="text-center text-sm text-gray-500 mt-6">
                ...
                <Link href={`/login?callbackUrl=${encodeURIComponent(callbackUrl)}`} className="font-semibold hover:opacity-75" style={{ color: "#B07848" }}>Sign in</Link>
              </p>
            </div>
          </div>
        </div>
